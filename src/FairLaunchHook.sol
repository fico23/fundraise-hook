...
contract FairLaunchHook is BaseHook {
    ...
    uint256 immutable public constantPriceEnd;
    uint256 immutable public fairLaunchEnd;
    uint160 immutable public startSqrtPriceX96;

    uint8 public fairLaunchStatus; // 0 - none, 1 - started, 2 - ended, 3 - failed

    constructor(IPoolManager poolManager, uint256 constantPriceDuration, uint256 fairLaunchDuration, uint160 sqrtPriceX96) BaseHook(poolManager) {
